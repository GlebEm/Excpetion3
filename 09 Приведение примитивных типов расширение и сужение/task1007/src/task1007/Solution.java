...
public class Solution {
    public static void main(String[] args) {
        long l =  1234_564_890L; //в байте = 27
        int x = (short) 0b1000_1100_1010;//в байте = -53
        double m = (short) 110_987_654_6299.123_34;//в байте = -1
        float f = (int) l++ + 10 + ++x - (float) m; // в байте = -16,0 , нужно получить тут 1234567000
        l = (long) f / 1000; // в лонге 0
        System.out.println(l); //8. Программа должна выводить текст 1234567.*/
    }
}